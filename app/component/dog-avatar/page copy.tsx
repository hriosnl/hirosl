  ...
  return (
    <div className="flex flex-col items-center gap-y-6">
      <div className="text-2xl font-medium">
        Choose Your <span className="opacity-40">Dog</span>avatar
      </div>
              ...
              <div className="relative">
                ...
                {showTooltip === dog.id && (
                  <motion.div
                    ...
                    className="absolute -top-9 left-1/2 -translate-x-1/2 text-white px-3 py-1 rounded-lg text-sm whitespace-nowrap z-10"
                    style={{
