...
export default function CancerStatusChecker() {
  ...
  const getDefaultNote = (name: string): string => {
    ...
    // === YG + Burning Sun network notes (focus on masterminds/executors) ===
    if (name.includes("Yang Hyun-suk"))
