...
export default function Page() {
  return (
    <div className={cn("h-screen flex flex-col", roboto.className)}>
      <BackHome />
...
function DynamicToggle() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="w-96 h-14 shadow-2xl rounded-4xl border border-gray-100 p-0.5 relative">
                ...
                <div className="flex w-full">
                  ...
                  >
                    <motion.span
                      animate={{
                        color:
                          activeSubTab === "monthly" ? "#000000" : "#DDDAD0",
                      }}
                    >
                      Monthly
                    </motion.span>
                  ...
                  >
                    <motion.span
                      animate={{
                        color:
                          activeSubTab === "annual" ? "#000000" : "#DDDAD0",
                      }}
                    >
                      Annual
                    </motion.span>
