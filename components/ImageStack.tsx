...
export default function ImageStack() {
  ...
  useOnClickOutside(boxRef as React.RefObject<HTMLElement>, () => {
    setIsOpen(false);
    setSelectedImages([]);
  });
  ...
  return (
    <MotionConfig transition={{ type: "spring", duration: 0.45, bounce: 0 }}>
      <div
        className={cn(
          "flex justify-center items-center h-[15rem] relative",
          roboto.className
        )}
      >
        {!isOpen ? (
        ...
        {isOpen ? (
          <div className="size-3/5 select-none flex flex-col justify-center items-center">
            <div className="grid grid-cols-2 gap-3" ref={boxRef}>
            ...
            <motion.button
              className="text-gray-700 py-1 w-2/4 mt-6 rounded-xl bg-white text-sm cursor-pointer"
...
// const landscapes = ["japan", "jungle", "new-york", "desert"];
